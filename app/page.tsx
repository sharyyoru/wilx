...
import { Car, Bot, Wrench, Coffee, Beef, Droplets } from "lucide-react";
        ...
        <section className="border-t-4 border-white bg-black px-4 py-16 sm:px-8 lg:px-12">
          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-3 shrink-0">
              {([
                { label: "Lipton",      Icon: Coffee   },
                { label: "McDonald's",  Icon: Beef     },
                { label: "Total",       Icon: Droplets },
              ] as const).map(({ label, Icon }) => (
                <div key={label} className="flex items-center gap-2 border border-white/15 bg-white/5 px-3 py-2 rounded-sm">
